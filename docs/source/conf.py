...
# ing_kedro_code_breakfast documentation build
...
from ing_kedro_code_breakfast import __version__ as release

# -- Project information -----------------------------------------------------

project = "ing_kedro_code_breakfast"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "ing_kedro_code_breakfastdoc"
...
latex_documents = [
    (
        master_doc,
        "ing_kedro_code_breakfast.tex",
        "ing_kedro_code_breakfast Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ing_kedro_code_breakfast",
        "Project ing_kedro_code_breakfast codebase.",
        "Data-Science",
    )
]
